...
- (CGFloat)contentHeight {
    ...
    CGFloat contentHeight = titleHeight + rowHeightSum + kTabbarSafeBottomMargin;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (section == 1) {
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MSWIDTH, kFSActionSheetSectionHeight)];
